...
screen Fl_quest_list:
    ...
    text ["{font=[Fl_Script]}{color=#808080}Список предметов:{/color}{/font}"]:
        size 50
        ypos 30
        xalign 0.967
    if ph < 1:
        text ["{font=[Fl_Script]}Телефон:{/font}"]:
            size 40
            ypos 85
            xalign 0.967
        add "objects/Fl_check-mark1.png" at Fl_zoom_pr(0.07):
            ypos 92
            xalign 0.99
    else:
        text ["{font=[Fl_Script]}Телефон:{/font}"]:
            ...
            ypos 85
            xalign 0.967
        add "objects/Fl_check-mark2.png" at Fl_zoom_pr(0.07):
            ypos 85
            xalign 0.99

    if hp < 1:
        text ["{font=[Fl_Script]}Наушники:{/font}"]:
            size 40
            ypos 125
            xalign 0.967
        add "objects/Fl_check-mark1.png" at Fl_zoom_pr(0.07):
