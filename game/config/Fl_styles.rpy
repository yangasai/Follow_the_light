...
init python:
    ...
    style.Fl_text_big_save_load.font                     = "font/Fl_mainmenu.ttf"
    ...
    style.Fl_text_small_setting.font                         = "font/Fl_mainmenu.ttf"
    ...
    style.Fl_text_setting.font                           = "font/Fl_mainmenu.ttf"
    ...
    style.Fl_save_load_button.font                       = "font/Fl_mainmenu.ttf"
    style.Fl_save_load_button.size                       = 22
    style.Fl_save_load_button.color                      = "#FFFFFF"
    style.Fl_save_load_button.background                 = "gui/main_menu/save/save_load_button_idle.png"
    style.Fl_save_load_button.hover_background           = "gui/main_menu/save/save_load_button_hover.png"
    style.Fl_save_load_button.selected_background        = "gui/main_menu/save/save_load_button_selected.png"
    style.Fl_save_load_button.selected_hover_background  = "gui/main_menu/save/save_load_button_selected.png"
    style.Fl_save_load_button.selected_idle_background   = "gui//main_menu/save/save_load_button_selected.png"
    
    style.Fl_text_small_save_load                        = Style(style.default)
    style.Fl_text_small_save_load.font                   = "font/Fl_mainmenu.ttf"
    ...
    style.Fl_text_label.font                                 = "font/Fl_mainmenu.ttf"
    ...
    style.Fl_loading_bar                                         = Style(style.default)
    style.Fl_loading_bar.left_bar                                = Frame("gui/loading/bar_full.png")
