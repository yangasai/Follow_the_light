...
label dls_q66_prolog:
    ...
    $ Fl.say(Fl_an, "Мне зовут - Аня, а тебя?")
    ...
    $ Fl.say(Fl_r, "Аня захрипела... Она начала кашлить кровью, попутно пытаясь бороться со смертью.")
...
label nightcatacombs_win:
    ...
    $ Fl.say(Fl_r, "Наверное так и есть. Ведь мир всегда жаждит чего нового, а мы режиссёры пионерлагеря, как раз таки исполняем свои и чужие прихоти. {w}Да, теперь то всё сходится!")
    ...
    $ Fl.say(Fl_pib, "Но я уверен, что скоро всё закончиться...")
    $ Fl.HideScreens(_with=Fl_dissolve1)
    $ Fl.StopMusic(6)
    scene bg Fl_black with Fl_dissolve2
    ...
    $ Fl.say(Fl_mi, "Ян, хватит смущать меня!")
    ...
    $ Fl.say(Fl_vp, "И так, зачем ты пожаловало к нам, Тихоня?")
    ...
    show Fl_dust_full
    with Fl_fast
    $ Fl.say(Fl_r, "Спустя несколько минут я был на месте. {w}Дыра уже была проделана, а значит кто-то уже шастал тут до меня.")
    $ Fl.StopMusic(4)
    ...
    $ Fl.say(Fl_th, "Чего это они? Ох не говорите мне, что она ещё жива, и сейчас...")
...
label disco_win:
    ...
    $ Fl.say(Fl_r, "Шмыг. И ещё один. {w}Девушка тряслась и старалась восстановить дыхание, её грудь сбешенной скоростью качала воздух, будто она боролась с {i}гипоксией{/i}.")
...
label lent_vibor:
    ...
    $ Fl.say(Fl_th, "Что? Он выключился?")
    ...
    $ Fl.say(Fl_pi, "Звук устройства, я подумал что оно выключилось, но ты так заставила меня думать. А твои удары. Ты же изначально била с левой ноги, но меня заставила думать, что он был с правой.")
...
label task_over:
    ...
    $ Fl.say(Fl_th, "А переволощение это совсем другая способность.")
    ...
    $ Fl.say(Fl_liz, "Будем учить тебя перемещаться между лагерями. Или ты планируешь здесь засесь навечно, как в своём лагере?")
    ...
    $ Fl.say(Fl_liz, "А потом выждала момент с булкой.")
    ...
    $ Fl.say(Fl_q6, "А из какого ты периода?")
    $ Fl.say(Fl_cs, "Нулевой. Но как видишь пережила два поколения уже.")
    ...
    $ Fl.PlaySound("Fl_smoking", 1, 0, False)
    show Fl_fogging with Fl_dissolve2
    ...
    $ Fl.say(Fl_th, "Он явно не сам принял решение убить себя. {w}В его глазах чётко отражалась молба о помощи.")
    ...
    hide Fl_fogging with Fl_dissolve2
    ...
    $ Fl.AttackMaster(False)
    $ Fl.say(Fl_q6, "Тцц...")
    $ Fl.say(Fl_r, "Я рано раслабился, за первой атакой последовала вторая. Увернуться не получилось, сделав блок я из бежал прямого урона и ударил в ответ по лицу пионерке.")
    ...
    $ Fl.say(Fl_r, "Мой спокойный только сильнее сводил с ума пионерку.")
    ...
    $ Fl.DayTime("kira", "night")
    $ Fl.PlayMusic("Fl_bloodwork", 1, 5)
    $ Fl.say(Fl_q6, "Я разрушу все ваши планы!", _with=vpunch)
    $ Fl.say(Fl_r, "Дикий хохот залился по всему помещению, казалось что он эхом разбегается по всему туннелу.")
    $ Fl.say(Fl_q6, "И вы говорите я чудовище? Я псих?")
    $ Fl.say(Fl_q6, "Тогда кто вы?! Ради своей цели проводите дикие опыты над детьми, а после выкидываете словно мусор в случае неудачи.")
    ...
    $ Fl.say(Fl_q6, "Теперь моя очередь делать ход, я сотру вашу довольную ухмылку. Покажу вам прах ваших идеалов!")
    ...
    $ Fl.ShowScreens(_with=Fl_dissolve1)
    $ Fl.say(Fl_r, "После того как лифт оказался наверху, я уверенно зашагал в его сторону. Всё что я так долго искал, находилось в пресподне это мира, оставалось лишь спуститься к тайне что покрыла мраком Совёнок.")
    $ Fl.say(Fl_q6, "Ну вот и мы вновь встретимся доктор Парки.")
    $ Fl.HideScreens(_with=Fl_dissolve2)
    scene bg Fl_black with Fl_dissolve3
    $ Fl.StopAmbience(4)
    $ Fl.StopMusic(5)
